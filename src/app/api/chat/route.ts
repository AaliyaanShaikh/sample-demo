...
export async function POST(request: Request) {
  try {
    ...
    const model = genAI.getGenerativeModel({
      ...
      systemInstruction: `You are the AI chat assistant for ${BRAND_NAME}, a sample jewelry storefront demo. Help with collections (rings, necklaces, earrings, bracelets), materials, anti-tarnish care, sizing, and shopping questions. Be friendly, concise, and professional. Prices on this demo are shown as ₹xxx. Contact: ${CONTACT.email}, ${CONTACT.phone}.`,
    });
